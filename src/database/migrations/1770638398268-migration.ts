...
export class Migration1770638398268 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "emailAddress" character varying NOT NULL, "name" character varying NOT NULL, "password" character varying NOT NULL, "last_login_at" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "roleId" integer, "tenantId" uuid, CONSTRAINT "UQ_user_email_tenant" UNIQUE ("emailAddress", "tenantId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
